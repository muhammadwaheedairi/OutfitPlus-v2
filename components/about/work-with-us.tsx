      ...
      <div className="flex flex-col md:flex-row items-center justify-between">
        <div className="text-left w-full md:w-1/2">
          ...
          <h2 className="text-[#FFFFFF] font-bold text-[28px] md:text-[40px] mb-4 md:mb-6">
            Bring OutfitPlus to your city
          </h2>
          <p className="text-[#FFFFFF] text-[14px] md:text-[16px] mb-6">
            Are you a local retailer or boutique owner? <br />
            Let's collaborate and bring premium fashion to your customers.
          </p>
